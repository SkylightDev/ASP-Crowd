<%@ Page Title="Register an external login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="Wikipedia.IdentityAccount.RegisterExternalLogin" %>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    ...
                    <asp:ModelErrorMessage runat="server" ModelStateKey="NewUser" CssClass="text-error" />
                </div>
            </div>
