<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Wikipedia.IdentityAccount.Manage" %>
        ...
        <div class="col-md-12">
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePassword" Visible="false">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <asp:Label runat="server" ID="Label5" AssociatedControlID="ConfirmNewPassword" CssClass="col-md-2 control-label">Confirm new password</asp:Label>
                            <div class="col-md-10">
            ...
            <section id="externalLoginsForm">
                ...
                <asp:ListView runat="server"
                 ...
                 <uc:OpenAuthProviders ID="OpenAuthProviders2" runat="server" ReturnUrl="~/IdentityAccount/Manage.aspx" />
            </section>
