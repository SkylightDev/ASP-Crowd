<%@ Page Title="Edit Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Wikipedia.Pages.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %> - <%: PageTitleText %></h2>
    <hr />
    <div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-horizontal">
                ...
                <div class="form-group" runat="server" ID="PageTitleGroup">
                ...
                <div class="form-group" runat="server" ID="TagsGroup">
